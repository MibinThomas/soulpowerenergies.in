    ...
    <section className="py-20 bg-[#F8F9FC] text-[#0F172A] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <Badge variant="gold" className="px-3.5 py-1 sthira-pill bg-white text-[#D97706]">Why Choose Soul Power</Badge>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-[#0F172A] leading-tight">
              Local Service Excellence, Supported by Proven Engineering<span className="text-[#D97706]">.</span>
            </h2>
            ...
            <div className="p-6 rounded-[28px] sthira-card text-[#0F172A] space-y-4 shadow-xl">
              ...
              <div className="pt-2 flex flex-wrap gap-2 text-[11px] text-[#D97706] font-bold">
                <span className="px-3 py-1 rounded-full sthira-pill bg-slate-50">KSEB Compliant</span>
                <span className="px-3 py-1 rounded-full sthira-pill bg-slate-50">ANERT Guidelines</span>
                <span className="px-3 py-1 rounded-full sthira-pill bg-slate-50">MNRE Certified</span>
              </div>
            </div>
          </motion.div>
            ...
            {points.map((pt, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-6 rounded-[28px] sthira-card sthira-card-hover group"
                >
                  <div className="w-11 h-11 rounded-2xl bg-[#D97706]/10 text-[#D97706] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    <Icon className="w-5 h-5 stroke-[2.2]" />
                  </div>
                  <h3 className="text-base font-bold text-[#0F172A] mb-1.5 group-hover:text-[#D97706] transition-colors">
                    {pt.title}
                  </h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-medium">
                    {pt.description}
