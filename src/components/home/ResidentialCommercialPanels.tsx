      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="rounded-[32px] sthira-card group flex flex-col justify-between p-6 sm:p-8 shadow-xl"
          >
            <div>
              {/* Photo Banner */}
              <div className="relative w-full h-56 rounded-2xl overflow-hidden border border-slate-200/80 shadow-sm mb-6">
                <Image
              ...
              <div className="space-y-3">
                <h3 className="text-2xl sm:text-3xl font-black text-[#0F172A] leading-tight">
                  Eliminate rising electricity costs with a custom home rooftop solar system<span className="text-[#D97706]">.</span>
                </h3>
            ...
            <div className="pt-6 mt-6 border-t border-slate-100">
              <Link href="/solutions/residential-rooftop-solar">
                <Button variant="primary" size="md" className="w-full justify-between font-black rounded-full shadow-lg">
          ...
          >
            <div>
              ...
              <div className="space-y-3">
                <h3 className="text-2xl sm:text-3xl font-black text-[#0F172A] leading-tight">
                  Turn idle rooftop space into a high-yielding energy asset for your enterprise<span className="text-[#D97706]">.</span>
                </h3>
            ...
            <div className="pt-6 mt-6 border-t border-slate-100">
              <Link href="/solutions/commercial-industrial-solar">
                <Button variant="dark" size="md" className="w-full justify-between font-black rounded-full shadow-lg">
