...
export function ServicesOverview() {
  ...
  return (
    <>
      ...
      <section
        ref={targetRef}
        className="hidden lg:block relative h-[300vh] bg-[#0C0E12] text-[#F5EFE6]"
        id="services"
      >
        ...
        <div className="sticky top-0 h-screen flex flex-col justify-between overflow-hidden py-16">
          ...
          {/* Section Header */}
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full shrink-0 mb-6">
            <div className="flex items-end justify-between gap-6">
              ...
              <p className="text-sm text-[#EADBC8]/80 max-w-md leading-relaxed">
            ...
            <motion.div style={{ x }} className="flex gap-8 px-12 items-center">
              {servicesData.map((service, idx) => {
                ...
                return (
                  <div
                    key={service.id}
                    className="w-[520px] shrink-0 h-[480px] relative rounded-3xl nestive-card border border-[#EADBC8]/20 p-10 shadow-2xl flex flex-col justify-between group hover:border-[#E5BA73]/50 transition-all duration-500 bg-[#131722]/80 backdrop-blur-2xl overflow-hidden"
                  >
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-[#F5EFE6] mb-3 font-heading group-hover:text-[#E5BA73] transition-colors leading-snug">
                        {service.title}
                      </h3>

                      {/* Description */}
                      <p className="text-sm text-[#EADBC8]/80 leading-relaxed line-clamp-3 mb-4">
                        {service.description}
                      </p>
                    </div>
                    ...
                    <div className="relative z-10 pt-4 border-t border-[#EADBC8]/15 space-y-4">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center justify-between w-full p-3 rounded-2xl bg-[#EADBC8]/10 hover:bg-[#E5BA73] text-[#F5EFE6] hover:text-[#0C0E12] text-sm font-bold transition-all group/btn border border-[#EADBC8]/15"
                      >
      ...
      {/* ======================================================== */}
      <section className="block lg:hidden py-16 bg-[#0C0E12] text-[#F5EFE6] relative overflow-hidden" id="services-mobile">
          ...
          >
            {servicesData.map((service, idx) => {
              ...
              return (
                <div
                  key={service.id}
                  className="w-[85vw] max-w-[340px] shrink-0 snap-center rounded-3xl nestive-card border border-[#EADBC8]/20 p-6 shadow-xl flex flex-col justify-between bg-[#131722]/90 backdrop-blur-xl relative overflow-hidden"
                >
                  <span className="absolute -right-2 -bottom-4 text-7xl font-black font-heading text-[#EADBC8]/5 select-none pointer-events-none">
                    {formattedNumber}
                  </span>

                  <div>
                    <div className="flex items-center justify-between mb-4 relative z-10">
                      <div className="w-12 h-12 rounded-2xl bg-[#EADBC8]/10 text-[#E5BA73] flex items-center justify-center border border-[#EADBC8]/20">
                        <Icon className="w-6 h-6" />
                      </div>

                      {service.isComingSoon ? (
                        <Badge variant="comingSoon" className="nestive-pill text-[10px]">
                          {service.badge || "Coming Soon"}
                        </Badge>
                      ) : (
                        <span className="text-[10px] font-bold text-[#E5BA73] uppercase tracking-wider nestive-pill px-2.5 py-0.5 rounded-full border border-[#EADBC8]/15">
                          {formattedNumber} / 06
                        </span>
                      )}
                    </div>
                    ...
                    <h3 className="text-lg font-bold text-[#F5EFE6] mb-2 font-heading leading-snug">
                      {service.title}
                    </h3>

                    <p className="text-xs text-[#EADBC8]/80 leading-relaxed line-clamp-3 mb-4">
                      {service.description}
                    </p>
                  </div>

                  <div className="relative z-10 pt-4 border-t border-[#EADBC8]/15 space-y-3">
                    <Link
                      href={`/solutions#${service.slug}`}
                      className="inline-flex items-center justify-between w-full p-2.5 rounded-xl bg-[#E5BA73] text-[#0C0E12] text-xs font-bold transition-all shadow-md"
                    >
          ...
          <div className="flex items-center justify-between pt-2">
              ...
              {servicesData.map((_, i) => (
                <span
                  ...
                  className={`h-2 rounded-full transition-all ${
                    activeMobileIdx === i ? "w-6 bg-[#E5BA73]" : "w-2 bg-[#EADBC8]/25"
                  }`}
                />
              ))}
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 rounded-full nestive-card border border-[#EADBC8]/20 text-[#E5BA73] active:scale-95 transition-all"
