      ...
      <main id="main-content" className="flex-1 bg-[#0C0E12] text-[#F5EFE6]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-6 space-y-6">
                <Badge variant="gold" className="px-3.5 py-1 nestive-pill text-[#E5BA73]">Company Overview</Badge>
                ...
                <div className="p-4 rounded-2xl nestive-card text-[#F5EFE6] text-xs flex items-start gap-3 border border-[#EADBC8]/15">
              ...
              <div className="lg:col-span-6">
                <div className="relative rounded-3xl overflow-hidden nestive-card border border-[#EADBC8]/20 shadow-2xl">
                  <Image
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0C0E12]/90 via-transparent to-transparent" />
                  <div className="absolute bottom-6 inset-x-6 p-4 rounded-2xl nestive-card text-[#F5EFE6] space-y-1 border border-[#EADBC8]/20">
                    <p className="text-xs font-bold text-[#E5BA73]">Northern Kerala Environment</p>
                    <p className="text-xs text-[#EADBC8]/80">Customized solar structural mounting for local tropical climate</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Mission */}
              <div className="p-8 sm:p-10 rounded-3xl nestive-card border border-[#EADBC8]/15 space-y-4 shadow-xl">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div className="text-center max-w-2xl mx-auto space-y-3">
              <Badge variant="gold" className="px-3.5 py-1 nestive-pill text-[#E5BA73]">Our Core Principles</Badge>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {values.map((v, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-6 rounded-3xl nestive-card border border-[#EADBC8]/15 shadow-md space-y-3"
                  >
                    <div className="w-10 h-10 rounded-xl bg-[#EADBC8]/10 text-[#E5BA73] flex items-center justify-center border border-[#EADBC8]/20">
                      <Icon className="w-5 h-5" />
                    </div>
                    <h3 className="text-lg font-bold text-[#F5EFE6] font-heading">{v.title}</h3>
                    <p className="text-xs text-[#EADBC8]/70 leading-relaxed">{v.desc}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="py-16" id="partnership">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="p-6 rounded-3xl nestive-card border border-[#EADBC8]/20 text-[#F5EFE6] text-xs space-y-3 shadow-xl">
              <div className="flex items-center gap-2 text-[#E5BA73] font-bold">
                <ShieldCheck className="w-4 h-4" />
                <span>Accreditation Notice</span>
              </div>
              <p className="text-[#EADBC8]/80">{siteConfig.partner.wording}</p>
            </div>

            <div className="pt-4">
              <Link href="/contact#assessment">
                <Button variant="primary" size="lg" className="font-bold rounded-xl shadow-xl">
