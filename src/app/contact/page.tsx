          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="space-y-3">
                <Badge variant="gold" className="px-3.5 py-1 nestive-pill text-amber-300">Thiruvambady HQ</Badge>
                <h2 className="text-3xl font-normal font-serif italic text-white">
              ...
              <div className="space-y-4">
                {/* Office Address */}
                <div className="p-5 rounded-2xl nestive-card shadow-md flex items-start gap-4">
                  <div className="p-3 rounded-xl bg-amber-400/20 text-amber-300 border border-amber-300/30 shrink-0">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div className="space-y-1">
                    <span className="text-xs font-bold uppercase tracking-wider text-amber-300">Office Location</span>
                ...
                <div className="p-5 rounded-2xl nestive-card shadow-md flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <span className="text-xs font-bold uppercase tracking-wider text-amber-300">Phone Contact</span>
                    {hasPhone ? (
                      <a href={`tel:${siteConfig.contact.phone}`} className="text-base font-bold text-white hover:text-amber-300 font-heading block">
                ...
                <div className="p-5 rounded-2xl nestive-card shadow-md flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <span className="text-xs font-bold uppercase tracking-wider text-amber-300">Email Address</span>
                    {hasEmail ? (
                      <a href={`mailto:${siteConfig.contact.email}`} className="text-base font-bold text-white hover:text-amber-300 font-heading block">
                ...
                {/* WhatsApp */}
                <div className="p-5 rounded-2xl nestive-card shadow-md flex items-start gap-4">
                  <div className="p-3 rounded-xl bg-emerald-400/20 text-emerald-300 border border-emerald-300/30 shrink-0">
                    <MessageCircle className="w-5 h-5 text-emerald-300" />
                  </div>
                  <div className="space-y-1">
                    <span className="text-xs font-bold uppercase tracking-wider text-emerald-300">WhatsApp Support</span>
                    {hasWhatsapp ? (
                      <a
                        href={`https://wa.me/${siteConfig.contact.whatsapp}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-base font-bold text-emerald-300 hover:underline font-heading block"
                      >
                ...
                <div className="p-5 rounded-2xl nestive-card shadow-md flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <span className="text-xs font-bold uppercase tracking-wider text-amber-300">Business Hours</span>
              ...
              {/* Partnership Banner */}
              <div className="p-6 rounded-3xl nestive-card text-white space-y-3 shadow-lg">
